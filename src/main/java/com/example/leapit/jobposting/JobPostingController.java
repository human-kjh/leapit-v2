...
public class JobPostingController {
    ...
    @GetMapping("/s/api/jobposting/detail/{id}")
    public ResponseEntity<?> getDetailForm(@PathVariable Integer id) {
        JobPostingResponse.DTO respDTO = jobPostingService.getDetailForm(id);
        return Resp.ok(respDTO);
    }
}